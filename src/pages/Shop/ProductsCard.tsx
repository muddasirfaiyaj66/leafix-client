...
const ProductsCard = () => {
    return (
        <div className="relative flex w-full h-[36rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
  <div className="relative mx-4 mt-4 overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
    <img
      src="https://i.postimg.cc/FRc7GBr5/133124.jpg" className="w-full h-full object-cover"
    />
  ...
  <div className="p-6">
    ...
    <p className="text-xl"><span className="font-bold text-primary text-xl">Price:   </span>  50 $</p>
